...
const Dashboard = () => { // Renamed the component to Dashboard
  const [isCollapsed, setIsCollapsed] = useState(false);
  const [searchQuery, setSearchQuery] = useState("");

  const departmentNames = [
    "Human Resource Department", "Accounting Department", "Engineering Department", "Information Technology Department", "Procurement, Property and Supply Department", "Billing and Claims",
    "Anesthesia Department", "Chief of Clinics", "Dental Department", "Family Medicine Department", "Internal Medicine Department", "Obstetrics and Gynecology Department",
    "Emergency Department", "Outpatient Department", "Nursing Service Division", "Respiratory Therapy Department", "Health Information Management", "Radiology Department", "Pathology Department", "Dietary Department", "Pharmacy Department",
    "Admitting Section",
  ];

  const departmentHeads = [
    "Ms. Marion May M. Cervera", "Ms. Arlene T. Novilla, CPA", "Engr. Marc Napoleon Quiaoit III", "Mr. Jan Bert I. Doquenia", "Mr. Luisito P. Salvador", "Ms. Luzvi May B. Quiaoit",
    "AMalaika Salido-Ecalnir, MD", "Marichu A. Brillantes, MD", "Arnold Benedict Yambao, DMD", "Robert B. Belleza, MD", "Clodoaido M. Caringal, MD",
  ...
  const cardColors = ["bg-neutral-200"];
                  ...
                  return (
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-400">Employees: {card.employees}</p>
                      </div>
                    </div>
                  );
                })
